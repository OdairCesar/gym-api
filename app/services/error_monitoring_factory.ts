...
import { SentryMonitoringService } from './sentry_monitoring_service.js'
import { NullMonitoringService } from './null_monitoring_service.js'
...
class ErrorMonitoringFactory {
  private static instance: ErrorMonitoringService | null = null
  ...
  private static createService(): ErrorMonitoringService {
